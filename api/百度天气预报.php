...
*/
$ch = curl_init();//初始化创建一个新crul资源
$url = 'http://apis.baidu.com/heweather/weather/free?city=beijing';
$header = array(
    'apikey: 835aa5727a56da1df74ee1a6d69974a7',
);
// 添加apikey到header
...
｝
备注 :
在请求参数中，city城市名称可以用cityid或cityip代替。国内城市的查询建议使用cityid

国内cityid可以参考 http://www.heweather.com/documents/cn-city-list

cityip可以通过ip地址返回所在城市的天气

完整天气数据和文档请参考http://www.heweather.com/documents/api*/